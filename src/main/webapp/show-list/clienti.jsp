...
<body>
    ...
    String result = (String) request.getAttribute("result"); //messaggio di result
      ...
      int customerId = -1;
      CustomerImpl customerImpl = null;
     if(customerId1 != null) {
   
     customerId = Integer.parseInt(customerId1); 
     
     customerImpl = new CustomerImpl(con);
			...
			<table class="table table-bordered table-striped">
				<thead>
					<tr>
						...
						<th>Price</th>
						<th>Animal Type</th>
						<th class="d-flex justify-content-between">Registration
							number <a href="clienti.jsp"> <i
								class="fa-solid fa-rectangle-xmark text-danger"></i></a>
						</th>
